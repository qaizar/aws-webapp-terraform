...
<body>
  ...
  <nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
    <a class="navbar-brand" href="#">AWS-TF</a>
  ...
  <main role="main" class="container">
    ...
    <h2 class="mt-5 mb-3">New article</h2>


    <form action="validation.php" method="post">
      <div class="form-group">
        <label for="title">Title <span style="color: red; font-weight: bold;">*</span></label>
        <input type="text" class="form-control" id="title" name="title" placeholder="title of your article" required="required">
      </div>

      <div class="form-group">
        <label for="author">Author Name <span style="color: red; font-weight: bold;">*</span></label>
        <input type="text" class="form-control" id="author" name="author" placeholder="author name" required="required">
      </div>
      
      <div class="form-group">
        <label for="content">Content <span style="color: red; font-weight: bold;">*</span></label>
    ...
    <h2 class="mt-5 mb-5">List of Articles</h2>
